...
custom_hh_model custom_hh_model_LTX_mod;
#endif

// -- DynModule functions ------------------------------------------------------

custom_hh_model::custom_hh_model()
{
#ifdef LINKED_MODULE
...
const std::string
custom_hh_model::name(void) const
{
  return std::string("custom_hh_model"); // Return name of the module
}

const std::string
custom_hh_model::commandstring( void ) const
{
  // Instruct the interpreter to load custom_hh_model-init.sli
  return std::string( "(custom_hh_model-init) run" );
}

//-------------------------------------------------------------------------------------
void
custom_hh_model::init( SLIInterpreter* i )
{
    nest::kernel().model_manager.register_node_model< custom_hh >("custom_hh" );
} // custom_hh_model::init()